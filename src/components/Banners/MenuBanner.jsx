...
export const MenuBanner = () => {
  ...
  const rawScale = useTransform(scrollYProgress, [0.1, 0.7], [1, 0.7]);
  ...
  const cardOpacity = useTransform(scrollYProgress, [0.5, 0.9], [1, 0]);
  const triangleY = useTransform(scrollYProgress, [0, 1], [-30, 30]);
  ...
  return (
    <>
      <section
        ref={sectionRef}
        id="products"
        className="bg-[#ABB7E2] text-black relative h-[160vh] scroll-mt-20"
      >
        {/* Sticky container */}
        <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden">
          ...
          <div className="container h-full flex flex-col justify-center pt-4 pb-6 z-10">
            {/* Header section */}
            <motion.div
            ...
            >
              ...
              >
                ...
                sit, maxime qui modi iure illo mollitia porro.
              </motion.div>
            </motion.div>
